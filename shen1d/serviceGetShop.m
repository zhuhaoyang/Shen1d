...
{
	if (nil != m_delegate
		&& [m_delegate respondsToSelector:@selector(serviceGetShopCallBack:withErrorMessage:)])
	{
		[m_delegate serviceGetShopCallBack:m_dicReceiveData withErrorMessage:error];
	}
}
