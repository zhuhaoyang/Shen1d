...
@implementation serviceDelMyShop
...
{
	if (nil != m_delegate
		&& [m_delegate respondsToSelector:@selector(serviceDelMyShopCallBack:withErrorMessage:)])
	{
		[m_delegate serviceDelMyShopCallBack:m_dicReceiveData withErrorMessage:error];
	}
}
