...
@implementation serviceGetMyShops
...
{
	if (nil != m_delegate
		&& [m_delegate respondsToSelector:@selector(serviceGetMyShopsCallBack:withErrorMessage:)])
	{
		[m_delegate serviceGetMyShopsCallBack:m_dicReceiveData withErrorMessage:error];
	}
}
