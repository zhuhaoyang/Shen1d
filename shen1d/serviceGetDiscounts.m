...
@implementation serviceGetDiscounts
...
{
	if (nil != m_delegate
		&& [m_delegate respondsToSelector:@selector(serviceGetDiscountsCallBack:withErrorMessage:)])
	{
		[m_delegate serviceGetDiscountsCallBack:m_dicReceiveData withErrorMessage:error];
	}
}
