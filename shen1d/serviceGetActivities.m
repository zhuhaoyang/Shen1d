...
@implementation serviceGetActivities
...
{
	if (nil != m_delegate
		&& [m_delegate respondsToSelector:@selector(serviceGetActivitiesCallBack:withErrorMessage:)])
	{
		[m_delegate serviceGetActivitiesCallBack:m_dicReceiveData withErrorMessage:error];
	}
}
