...
{
	if (nil != m_delegate
		&& [m_delegate respondsToSelector:@selector(serviceRegisterCallBack:withErrorMessage:)])
	{
		[m_delegate serviceRegisterCallBack:m_dicReceiveData withErrorMessage:error];
	}
}
